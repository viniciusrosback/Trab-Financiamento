...
public class Programa {
	...
	public static void main(String[] args) {
		...
		while(salario < 0) {
			System.out.print("0 salario nao pode ser negativo. Tente novamente: ");
			salario = sc.nextDouble();
		}
		...
		while(prestacao > 0.3 * salario) {
			System.out.print("Capacidade de pagamento excedia! Tente novamente: ");
			totalFinanciado = sc.nextDouble();
		...
		do {
			...
			System.out.println("3 - Mostrar valor de cada prestacao");
